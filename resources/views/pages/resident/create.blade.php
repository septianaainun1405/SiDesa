...
@section('content')
    ...
    @if ($errors->any())
        <div class="alert alert-danger alert-dismissible fade show shadow-sm" role="alert">
            <strong><i class="fas fa-exclamation-circle"></i> Ups, ada data yang belum sesuai:</strong>
            <ul class="mb-0 mt-1">
    ...
    <div class="row">
        <div class="col">
            <form action="/residents" method="POST" class="needs-validation" novalidate>
                @csrf
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text"
                                ...
                                id="phone" name="phone" maxlength="15" value="{{ old('phone') }}"
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control @error('status') is-invalid @enderror"
                                ...
                                <option value="" disabled {{ old('status') ? '' : 'selected' }}>Pilih Status Penduduk</option>
